...
def playDance(step, robots, dances, arms, play_state):
    state = play_state
    print(robots)
    print(state)
    if state == "combine":
...
def run(start):
    ...
    # elif start == 'b':
        ...
        # print(play_state)
        # print("iter 2" + play_state)
        # game_of_life_music.init_and_run_contagion(dances, arms, 3, play_state)
        # setup()
        # time.sleep(6)
        # for a in arms:
        #     a.set_mode(1)
...
if __name__ == "__main__":
    ...
    # directory = '/home/codmusic/Desktop/FOREST/Game_of_Life/game_of_life_total_csvs'
    directory = '/home/codmusic/Desktop/FOREST/Game_of_Life/game_of_life_fast_csvs'
