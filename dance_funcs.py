...
ALIVE_S = [[0, 90, 0], [-30, 90], 0, [30, 60], 0, 0, 0]
ALIVE_T = [[1, 1, 2], [1, 3], 4, [1, 3], 4, 4, 4]
ALIVE = dance_step.Dance_Step("ALIVE", dance_step_arr=ALIVE_S, dance_step_t_arr=ALIVE_T)

DEAD_S = [[0, 90, 0], [30, -90], 0, [-30, 60], 0, 0, 0]
DEAD_T = [[1, 1, 2], [1, 3], 4, [1, 3], 4, 4, 4]
DEAD = dance_step.Dance_Step("DEAD", dance_step_arr=DEAD_S, dance_step_t_arr=DEAD_T)

DYING_S = [0, 0, 0, [-45, 0, 45], [0, -30, 60, -30], [30, 0, -30], 0]
DYING_T = [4, 4, 4, [1, 2, 1], [1, 1, 1, 1], [1, 2, 1], 4]
DYING = dance_step.Dance_Step("DYING", dance_step_arr=DYING_S, dance_step_t_arr=DYING_T, init_pos=[90, -60, 0, 120, 0, 0, 0])

LIVING_S = [0, 0, [0, -30, 60, -30], 0, [45, 0, -45], [40, 0, -40], 0]
LIVING_T = [4, 4, [1, 1, 1, 1], 4, [1, 2, 1], [1, 2, 1], 4]
LIVING = dance_step.Dance_Step("LIVING", dance_step_arr=LIVING_S, dance_step_t_arr=LIVING_T, init_pos=[90, 60, 0, 180, 0, 0, 0])

ALIVE_2_DEAD_S = [0, -120, 0, -60, 0, 0, 0]
ALIVE_2_DEAD_T = [4, 4, 4, 4, 4, 4, 4]
ALIVE_2_DEAD = dance_step.Dance_Step("ALIVE_2_DEAD", dance_step_arr=ALIVE_2_DEAD_S, dance_step_t_arr=ALIVE_2_DEAD_T, init_pos=[90, 60, 0, 180, 0, 0, 0])

DEAD_2_ALIVE_S = [0, 120, 0, 60, 0, 0, 0]
...
DEAD_ALT_S = [0, -60, 0, -20, 0, 0, 0]
DEAD_ALT_T = [4, 4, 4, 4, 4, 4, 4]
DEAD_ALT = dance_step.Dance_Step("DEAD_ALT", dance_step_arr=DEAD_ALT_S, dance_step_t_arr=DEAD_ALT_T)

DYING_ALT_S = [[20, -40, 20, -20, 40, -20], [20, -40, 20, 20, -40, 20], 0, 0, [-15, 15, 15, -15], 0, 0]
DYING_ALT_T = [[0.5, 1, 0.5, 0.5, 1, 0.5], [0.5, 1, 0.5, 0.5, 1, 0.5], 4, 4, [1, 1, 1, 1], 4, 4]
DYING_ALT = dance_step.Dance_Step("DYING_ALT", dance_step_arr=DYING_ALT_S, dance_step_t_arr=DYING_ALT_T, init_pos=[0, -60, 0, 70, 0, 0, 0])

LIVING_ALT_S = [[-15, 15, 15, -15], 0, [-30, 30, 30, -30], 0, 0, [45, -45, 45, -45], 0]
LIVING_ALT_T = [[1, 1, 1, 1], 4, [1, 1, 1, 1], 4, 4, [1, 1, 1, 1], 4]
LIVING_ALT = dance_step.Dance_Step("LIVING_ALT", dance_step_arr=LIVING_ALT_S, dance_step_t_arr=LIVING_ALT_T, init_pos=[0, 30, 0, 120, 0, 0, 0])

ALIVE_2_DEAD_ALT_S = [0, -90, 0, -50, 0, 0, 0]
ALIVE_2_DEAD_ALT_T = [4, 4, 4, 4, 4, 4, 4]
ALIVE_2_DEAD_ALT = dance_step.Dance_Step("ALIVE_2_DEAD_ALT", dance_step_arr=ALIVE_2_DEAD_ALT_S, dance_step_t_arr=ALIVE_2_DEAD_ALT_T, init_pos=[0, 30, 0, 120, 0, 0, 0])

DEAD_2_ALIVE_ALT_S = [0, 90, 0, 50, 0, 0, 0]
DEAD_2_ALIVE_ALT_T = [4, 4, 4, 4, 4, 4, 4]
DEAD_2_ALIVE_ALT = dance_step.Dance_Step("DEAD_2_ALIVE_ALT", dance_step_arr=DEAD_2_ALIVE_ALT_S, dance_step_t_arr=DEAD_2_ALIVE_ALT_T, init_pos=[0, -60, 0, 70, 0, 0, 0])
