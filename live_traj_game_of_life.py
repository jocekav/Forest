...
class Robot:
    ...
    def birth(self):
        birth_move = np.array(
            [self.joint_1, (self.joint_2 - 50), self.joint_3, (self.joint_4 + 60), self.joint_5, self.joint_6,
             self.joint_7], dtype=object)
        self.update_joints(birth_move)
        self.add_to_que(birth_move)

    def first_birth(self):
        birth_move = np.array(
            [self.joint_1, (self.joint_2 - 20), self.joint_3, (self.joint_4 + 30), self.joint_5, self.joint_6,
             self.joint_7])
        self.update_joints(birth_move)
        self.add_to_que(birth_move)
    ...
    def living(self):
        living_move_1 = np.array(
            [self.joint_1, self.joint_2, (self.joint_3 - 15), self.joint_4, self.joint_5, self.joint_6, self.joint_7],
            dtype=object)
        living_move_2 = np.array(
            [self.joint_1, self.joint_2, (self.joint_3 - 15), self.joint_4, self.joint_5, self.joint_6, self.joint_7],
            dtype=object)
    ...
    def dying(self):
        dying_move_1 = np.array(
            [(self.joint_1 + 20), self.joint_2, self.joint_3, self.joint_4, self.joint_5, self.joint_6, self.joint_7],
            dtype=object)
        dying_move_2 = np.array(
            [(self.joint_1 - 40), self.joint_2, self.joint_3, self.joint_4, self.joint_5, self.joint_6, self.joint_7],
            dtype=object)
        dying_move_3 = np.array(
            [(self.joint_1 + 20), self.joint_2, self.joint_3, self.joint_4, self.joint_5, self.joint_6, self.joint_7],
            dtype=object)
    ...
    def rotate(self, angle, action):
        if action == "death":
            rotate_move = np.array(
                [-(self.joint_1), self.joint_2, self.joint_3, self.joint_4, self.joint_5, self.joint_6, self.joint_7],
                dtype=object)

        if action == "birth":
            rotate_move = np.array(
                [(self.joint_1 + angle), self.joint_2, self.joint_3, self.joint_4, self.joint_5, self.joint_6,
                 self.joint_7], dtype=object)
...
def init_robots(arms):
    ROBOT_1 = Robot(0, arms[0])
    ROBOT_3 = Robot(2, arms[1])
    ROBOT_5 = Robot(4, arms[2])
    ROBOT_7 = Robot(6, arms[3])
    ROBOT_9 = Robot(8, arms[4])
